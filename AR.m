...
for i=500:50:length(lat1)
    ...
    theta_lat(j,:) = calcular_theta(lat1(i-499:i),4);
    theta_long(j,:) = calcular_theta(long1(i-499:i),4);
...
for i=500:50:length(lat2)
    ...
    theta_lat(j,:) = calcular_theta(lat2(i-499:i),4);
    theta_long(j,:) = calcular_theta(long2(i-499:i),4);
